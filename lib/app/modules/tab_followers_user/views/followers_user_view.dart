...
class FollowersUserView extends GetView<FollowersUserController> {
  FollowersUserView({Key? key}) : super(key: key);
  @override
  final controller = Get.put(FollowersUserController());
  @override
